...
def evaluate_metrics(Y_true,Y_predict,Y_predict_prob,test_title,test_folder,prob_en=False,confusion_en=False):
    ...
    if prob_en == True:
        ...
        fig.savefig('%s/%s.png'%(test_folder,test_title))
